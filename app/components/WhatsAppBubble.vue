...
<template>
  ...
  >
    <div
      ...
      role="tooltip"
    >
      ¿Dudas sobre un inmueble? Escríbenos por WhatsApp.
    </div>
    <a
      :href="waHref"
      target="_blank"
      rel="noopener noreferrer"
      class="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/30 ring-2 ring-white/15 transition hover:scale-[1.03] hover:bg-[#20bd5a] hover:shadow-xl hover:ring-white/25 focus:outline-none focus-visible:ring-2 focus-visible:ring-royal-400 focus-visible:ring-offset-2 focus-visible:ring-offset-night-900"
