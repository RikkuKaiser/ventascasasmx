...
<template>
  <header
    class="sticky top-0 z-50 border-b border-white/10 bg-night-900/40 backdrop-blur-2xl"
  >
    <div
    ...
    >
      ...
      >
        <span
          class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-royal-500 to-royal-800 shadow-royal ring-1 ring-white/20 transition group-hover:scale-105"
        >
      ...
      <div class="flex items-center gap-2">
        ...
        <template v-else>
          <NuxtLink
            to="/login"
            class="rounded-lg px-3 py-2 text-sm text-slate-300 hover:text-white"
          >
            Entrar
          </NuxtLink>
          <NuxtLink
            to="/registro"
            class="rounded-lg bg-gradient-to-r from-royal-600 to-royal-800 px-4 py-2 text-sm font-medium text-white shadow-royal ring-1 ring-white/20 transition hover:brightness-110"
          >
            Registrarse
          </NuxtLink>
        </template>
